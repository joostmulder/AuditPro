...
public extension UIView {
    ...
    fileprivate func addContentsStackView(toWrapperView wrapperView: UIView, withConfiguration config: HRToastConfig) -> UIStackView {
        ...
        leftSideConstraint.priority = UILayoutPriority(1000)
        ...
        rightSideConstraint.priority = UILayoutPriority(1000)
        ...
        leftSideEqualConstraint.priority = UILayoutPriority(250)
        ...
        rightSideEqualConstraint.priority = UILayoutPriority(250)
    ...
    fileprivate func addMessage(_ msg: String?, andTitle title: String?, toStackView parentStackView: UIStackView, withConfiguration config: HRToastConfig) {
        ...
        if let msg = msg {
            ...
            msgLabel.setContentHuggingPriority(UILayoutPriority(751), for: .vertical)
